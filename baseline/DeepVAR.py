                ...
                for hidden_size in [32]: # 16, 32, 64, 128
                    ...
                    for epoch in range(num_epochs):
                        ...
                        for train_id in range(len(train_batchxs)):
                            ...
                            path = rf"trained_model\DeepVAR_{encoder_length}_{n_component}_{n_hiddenlayer}_{hidden_size}_{epoch + 1}.pt"
                    ...
                    with open(rf"trained_model\DeepVAR_{encoder_length}_{n_component}_{n_hiddenlayer}_{hidden_size}_{epoch + 1}.json", "w") as f:
